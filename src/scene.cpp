...
const int nbr_trees = 400;
std::vector<cgp::vec3> trees = generate_positions_on_terrain(nbr_trees, terrain_length, 0.6f);
...
void scene_structure::initialize()
{
	...
	terrain.texture.load_and_initialize_texture_2d_on_gpu(project::path + "assets/texture_grass.jpg", GL_MIRRORED_REPEAT, GL_MIRRORED_REPEAT);
...
void scene_structure::display_frame()
{
	...
	for (int i = 0; i < nbr_trees; i++)
	{
		tree.model.translation = trees[i];
