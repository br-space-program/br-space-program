...
void scene_structure::initialize()
{
	...
	sphere.model.scaling = 100.0f;			 // coordinates are multiplied by 0.2 in the shader
	sphere.model.translation = {1, 100, 0};	 // coordinates are offseted by {1,2,0} in the shader
